...
export const ui = {
  es: {
    ...
    'whyus.3.title': 'Snacks Incluidos',
    'whyus.3.desc': 'Snacks y sorpresas en cada tour.',
    ...
    'homefaq.a5': 'Somos 100% familiares. Los niños menores de 5 años tienen descuentos especiales. Nuestras rutas incluyen paradas para descansar, comidas y momentos pensados para todas las edades. Para adultos mayores o personas con movilidad reducida, tenemos asientos preferenciales y el guía siempre está atento a las necesidades del grupo. Si tienes algún requerimiento especial — silla de ruedas, alergia alimentaria, necesidad médica — cuéntanos al reservar para que podamos prepararnos con anticipación.',
  ...
  en: {
    ...
    'homefaq.a5': 'Absolutely. We are a 100% family-friendly operator. Children under 5 receive special discounts. Our itineraries include rest stops, meal breaks, and activities designed for all ages. For seniors or guests with limited mobility, priority seating is available and our guide is always attentive to each group\'s needs. If you have any special requirements — wheelchair, dietary restriction, or medical need — let us know when booking so we can prepare in advance and make sure everyone has a wonderful experience.',
